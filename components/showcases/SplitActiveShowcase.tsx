...
export default function SplitActiveShowcase() {
  ...
  const tabs: TabItem[] = [
    ...
    },
    {
      ...
      spec1: 'Abu Dhabi Municipality Building Permits',
    ...
    {
      id: 'infrastructure',
      category: '04 / HEAVY INFRASTRUCTURE',
      title: 'Civil & Infrastructure Works',
      desc: 'Substations, deep foundations, structural concrete works, and heavy industrial facilities.',
      spec1: 'Microsilica C50/60 Concrete Castings',
      spec2: 'Municipal & Utility Authority Aligned',
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left p-5 rounded-lg border transition-all duration-300 flex flex-col gap-1.5 focus:outline-none cursor-pointer ${isActive
