  ...
  const items: DeckItem[] = [
    {
      ...
      spec: 'Area: 14,500 sqft | 2-Pearl Estidama',
        ...
        {deck.map((itemIdx, stackPos) => {
          ...
          return (
            <div
              ...
              className={`absolute inset-0 bg-app-card border border-app-border rounded-xl p-5 flex flex-col justify-between shadow-lg select-none cursor-pointer ${isTopCard ? 'shadow-2xl hover:border-brand-teal/40' : 'pointer-events-none'
                }`}
              style={{
