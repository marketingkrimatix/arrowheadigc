          ...
          <nav className="hidden lg:flex items-center space-x-7">
            ...
            >
              <Link
                ...
                className={`flex items-center text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal focus:outline-none cursor-pointer ${
                  pathname.startsWith('/services') ? 'text-brand-teal font-bold' : isHomeTransparent ? 'text-white/80' : 'text-app-fg/80'
                }`}
              >
                <span>Services</span>
                <svg
            ...
            >
              <Link
                ...
                className={`flex items-center text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal focus:outline-none cursor-pointer ${
                  pathname.startsWith('/sectors') ? 'text-brand-teal font-bold' : isHomeTransparent ? 'text-white/80' : 'text-app-fg/80'
                }`}
              >
                <span>Sectors</span>
                <svg
                  className={`ml-1 w-3.5 h-3.5 transition-transform duration-200 ${
                    sectorsOpen ? 'rotate-180 text-brand-teal' : isHomeTransparent ? 'text-white/40' : 'text-app-fg/40'
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
