...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-7">
            <Link
              href="/"
              className={`text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal ${pathname === '/' ? 'text-brand-teal font-bold' : 'text-app-fg/80'
                }`}
            >
              Home
            </Link>
            ...
            <Link
              href="/about"
              className={`text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal ${pathname === '/about' ? 'text-brand-teal font-bold' : 'text-app-fg/80'
                }`}
            >
              About
            </Link>
            ...
            >
              <button
                ...
                className={`flex items-center text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal focus:outline-none cursor-pointer ${pathname.startsWith('/services') ? 'text-brand-teal font-bold' : 'text-app-fg/80'
                  }`}
              >
                <span>Services</span>
                <svg
                  className={`ml-1 w-3.5 h-3.5 transition-transform duration-200 ${servicesOpen ? 'rotate-180 text-brand-teal' : 'text-app-fg/40'
                    }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <div
                className={`absolute left-[-250px] top-full pt-2 w-[760px] z-50 transform transition-all duration-200 ${servicesOpen
            ...
            >
              <button
                ...
                className={`flex items-center text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal focus:outline-none cursor-pointer ${pathname.startsWith('/sectors') ? 'text-brand-teal font-bold' : 'text-app-fg/80'
                  }`}
              >
                <span>Sectors</span>
                <svg
                  className={`ml-1 w-3.5 h-3.5 transition-transform duration-200 ${sectorsOpen ? 'rotate-180 text-brand-teal' : 'text-app-fg/40'
                    }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <div
                className={`absolute left-[-200px] top-full pt-2 w-[680px] z-50 transform transition-all duration-200 ${sectorsOpen
                    ? 'opacity-100 translate-y-0 visible'
                    : 'opacity-0 -translate-y-2 invisible pointer-events-none'
                  }`}
              >
            ...
            <Link
              href="/projects"
              className={`text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal ${pathname === '/projects' ? 'text-brand-teal font-bold' : 'text-app-fg/80'
                }`}
            >
              Projects
            </Link>
            ...
            <Link
              href="/insights"
              className={`text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal ${pathname === '/insights' ? 'text-brand-teal font-bold' : 'text-app-fg/80'
                }`}
            >
              Insights
            </Link>
            ...
            <Link
              href="/contact"
              className={`text-xs font-semibold uppercase tracking-wider transition-colors hover:text-brand-teal ${pathname === '/contact' ? 'text-brand-teal font-bold' : 'text-app-fg/80'
                }`}
            >
              Contact
            </Link>
      ...
      {/* Mobile Drawer */}
      <div
        className={`lg:hidden fixed inset-y-0 right-0 w-full max-w-xs bg-app-card border-l border-app-border shadow-2xl p-6 z-40 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
        ...
        <nav className="mt-8 flex flex-col space-y-5 overflow-y-auto max-h-[calc(100vh-180px)] pr-2">
          <Link
            href="/"
            className={`text-sm font-semibold uppercase tracking-wider hover:text-brand-teal transition-colors ${pathname === '/' ? 'text-brand-teal' : 'text-app-fg/80'
              }`}
          >
            Home
          </Link>
          ...
          <Link
            href="/about"
            className={`text-sm font-semibold uppercase tracking-wider hover:text-brand-teal transition-colors ${pathname === '/about' ? 'text-brand-teal font-bold' : 'text-app-fg/80'
              }`}
          >
            About
          </Link>
            ...
            <div className="pl-3 border-l border-brand-teal/20 flex flex-col space-y-2.5">
              {serviceLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`text-xs font-semibold hover:text-brand-teal transition-colors ${pathname === link.href ? 'text-brand-teal' : 'text-app-fg/60'
                    }`}
                >
                  {link.name}
                </Link>
          ...
          <Link
            href="/projects"
            className={`text-sm font-semibold uppercase tracking-wider hover:text-brand-teal transition-colors ${pathname === '/projects' ? 'text-brand-teal' : 'text-app-fg/80'
              }`}
          >
            Projects
          </Link>
          ...
          <Link
            href="/insights"
            className={`text-sm font-semibold uppercase tracking-wider hover:text-brand-teal transition-colors ${pathname === '/insights' ? 'text-brand-teal' : 'text-app-fg/80'
              }`}
          >
            Insights
          </Link>
          ...
          <Link
            href="/contact"
            className={`text-sm font-semibold uppercase tracking-wider hover:text-brand-teal transition-colors ${pathname === '/contact' ? 'text-brand-teal' : 'text-app-fg/80'
              }`}
          >
            Contact
          </Link>
