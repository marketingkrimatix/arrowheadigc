    ...
    <div id="residential-villas-sector-page" className="bg-app-bg text-app-fg min-h-screen">
      ...
      <section className="bg-app-bg py-20 relative overflow-hidden border-b border-app-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Breadcrumbs items={[{ name: 'Services', href: '/services' }, { name: 'Residential & Villas' }]} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="text-app-muted space-y-5 text-xs sm:text-sm leading-relaxed font-light">
                ...
                <p>
                  We manage the entire regulatory clearance flow through the TAMM digital portal. We coordinate approvals with Abu Dhabi Municipality for building permits, obtain electrical and water connections from local utility distribution authorities, align all designs with Estidama Pearl requirements, and integrate Civil Defense compliant fire safety systems, securing the legal Occupancy Certificate.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-app-secondary border-t border-app-border text-center">
        <h2 className="text-sm font-bold uppercase tracking-widest text-app-fg">Related Services for Private Clients</h2>
