...
export const metadata: Metadata = {
  ...
  description: 'Specialized general contracting for utility infrastructure in Abu Dhabi. Laying municipal-approved sewerage lines, high-pressure potable water grids, storm drainage systems, and multi-utility duct banks.',
  keywords: ['utility infrastructure Abu Dhabi', 'utility approved contractor', 'sewerage line contracting', 'storm water networks UAE', 'potable water systems', 'wet utilities contracting'],
  alternates: {
...
export default function InfrastructureUtilitiesSectorPage() {
  const capabilities = [
    {
      ...
      desc: 'Excavating, shoring, installing and testing major gravity sewer pipes and force mains. We build precast concrete manholes with high-performance anti-corrosive epoxy coat layers complying with municipal utility requirements.'
    },
    {
      title: 'Potable Water Distribution Loops',
      desc: 'Supply and installation of PE100 HDPE and DI mainlines. We execute DVS 2207 butt-fusion welding, electrofusion jointing, hydrostatic pressure testings, and sanitize loops for municipal utility compliance clearances.'
    },
    {
  ...
  const utilitySchema = {
    ...
    'knowsAbout': ['Municipal sewer networks', 'Potable water transmission', 'HDPE butt-fusion welding', 'Utility duct crossings', 'Dewatering permits']
  };
    ...
    <div id="infrastructure-utilities-sector-page" className="bg-app-bg text-app-fg min-h-screen">
      ...
      <section className="bg-app-bg py-20 relative overflow-hidden border-b border-app-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Breadcrumbs items={[{ name: 'Services', href: '/services' }, { name: 'Infrastructure & Utilities' }]} />
          ...
          <p className="mt-6 text-sm sm:text-base text-app-muted max-w-3xl font-light leading-relaxed">
            Grade-A civil utility pipeline installations and excavation networks. We build municipal-certified gravity sewers, potable water transmission loops, and robust multi-utility containment duct banks in Abu Dhabi.
          </p>
          <div className="mt-8">
            <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="text-app-muted space-y-5 text-xs sm:text-sm leading-relaxed font-light">
                ...
                <p>
                  We align all pipeline designs and excavations with municipal and utility standard detail drawings. We manage all compaction checks, weld recording parameters, and hydrostatic pressure testing, coordinating directly with municipal utility inspectors to obtain the necessary NOCs for public network integration.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col space-y-4">
                <Link href="/insights/hdpe-butt-fusion-welding-parameters" className="p-4 bg-app-card rounded border border-app-border hover:border-brand-teal transition-colors">
                  <span className="text-xs font-bold text-app-fg block">HDPE Butt-Fusion Welding Parameters</span>
      ...
      <section className="py-16 bg-app-secondary border-t border-app-border text-center">
        <h2 className="text-sm font-bold uppercase tracking-widest text-app-fg">Related Services for Infrastructure Clients</h2>
