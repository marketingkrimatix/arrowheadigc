...
export default function ServicesPage() {
  ...
  const sectorList = [
    ...
    },
    {
      ...
      desc: 'High-end fit-out interior construction, specialized HVAC chilled water configurations, and comprehensive preventive building facility management AMCs.',
